...
def main():
    ...
    parser.add_argument("--position-pct", type=float, default=3.0, help="Position size pct")
    ...
    parser.add_argument("--slippage", type=float, default=0.01, help="Slippage as fraction of premium")
